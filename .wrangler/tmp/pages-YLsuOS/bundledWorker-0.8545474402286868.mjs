...
var ai = /* @__PURE__ */ __name((e, t, s) => t in e ? ri(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s, "ai");
var y = /* @__PURE__ */ __name((e, t, s) => ai(e, typeof t != "symbol" ? t + "" : t, s), "y");
var yt = /* @__PURE__ */ __name((e, t, s) => t.has(e) || Gt("Cannot " + s), "yt");
var u = /* @__PURE__ */ __name((e, t, s) => (yt(e, t, "read from private field"), s ? s.call(e) : t.get(e)), "u");
var b = /* @__PURE__ */ __name((e, t, s) => t.has(e) ? Gt("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), "b");
var x = /* @__PURE__ */ __name((e, t, s, i) => (yt(e, t, "write to private field"), i ? i.call(e, s) : t.set(e, s), s), "x");
var A = /* @__PURE__ */ __name((e, t, s) => (yt(e, t, "access private method"), s), "A");
var Vt = /* @__PURE__ */ __name((e, t, s, i) => ({ set _(a) {
  x(e, t, a, s);
}, get _() {
  return u(e, t, i);
} }), "Vt");
var zt = /* @__PURE__ */ __name((e, t, s) => (i, a) => {
  let r = -1;
  return n(0);
  async function n(o) {
...
var oi = /* @__PURE__ */ __name(async (e, t = /* @__PURE__ */ Object.create(null)) => {
...
var gi = /* @__PURE__ */ __name((e) => Nt(e, decodeURI), "gi");
...
var ae = /* @__PURE__ */ __name((e, t, ...s) => (s.length && (t = ae(t, ...s)), `${(e == null ? void 0 : e[0]) === "/" ? "" : "/"}${e}${t === "/" ? "" : `${(e == null ? void 0 : e.at(-1)) === "/" ? "" : "/"}${(t == null ? void 0 : t[0]) === "/" ? t.slice(1) : t}`}`), "ae");
...
var xt = /* @__PURE__ */ __name((e) => /[%+]/.test(e) ? (e.indexOf("+") !== -1 && (e = e.replace(/\+/g, " ")), e.indexOf("%") !== -1 ? Nt(e, As) : e) : e, "xt");
var Es = /* @__PURE__ */ __name((e, t, s) => {
  let i;
  if (!s && t && !/[%+]/.test(t)) {
    let n = e.indexOf("?", 8);
    if (n === -1) return;
...
var yi = Es;
var xi = /* @__PURE__ */ __name((e, t) => Es(e, t, true), "xi");
var As = decodeURIComponent;
var Wt = /* @__PURE__ */ __name((e) => Nt(e, As), "Wt");
var ke;
var L;
var Q;
var Cs;
...
var Ss = (hs = class {
...
}, ke = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), Q = /* @__PURE__ */ new WeakSet(), Cs = /* @__PURE__ */ __name(function(e) {
  const t = u(this, L)[0][this.routeIndex][1][e], s = A(this, Q, _t).call(this, t);
  return s && /\%/.test(s) ? Wt(s) : s;
}, "Cs"), $s = /* @__PURE__ */ __name(function() {
  ...
  return e;
}, "$s"), _t = /* @__PURE__ */ __name(function(e) {
...
var bi = /[&<>'"]/;
var Ts = /* @__PURE__ */ __name(async (e, t) => {
  let s = "";
  t || (t = []);
...
var dt = /* @__PURE__ */ __name(async (e, t, s, i, a) => {
...
var ki = (ms = class {
  ...
  constructor(e, t) {
    ...
    y(this, "html", (e2, t2, s) => {
      const i = /* @__PURE__ */ __name((a) => A(this, Z, xe).call(this, a, t2, bt("text/html; charset=UTF-8", s)), "i");
...
var Ci = /* @__PURE__ */ __name((e) => e.text("404 Not Found", 404), "Ci");
...
var $i = (Ce = class {
  ...
  route(t, s) {
    ...
    return s.routes.map((a) => {
      var n;
      let r;
      s.errorHandler === Kt ? r = a.handler : (r = /* @__PURE__ */ __name(async (o, l) => (await zt([], s.errorHandler)(o, () => a.handler(o, l))).res, "r"), r[Si] = a.handler), A(n = i, _, ne).call(n, a.method, a.path, r, a.basePath);
    }), this;
  }
  basePath(t) {
  ...
  mount(t, s, i) {
    let a, r;
    i && (typeof i == "function" ? r = i : (r = i.optionHandler, i.replaceRequest === false ? a = /* @__PURE__ */ __name((l) => l, "a") : a = i.replaceRequest));
    const n = r ? (l) => {
      const c = r(l);
...
}, D = /* @__PURE__ */ new WeakMap(), _ = /* @__PURE__ */ new WeakSet(), Is = /* @__PURE__ */ __name(function() {
...
}, "Is"), H = /* @__PURE__ */ new WeakMap(), ne = /* @__PURE__ */ __name(function(t, s, i, a) {
...
}, "ne"), rt = /* @__PURE__ */ __name(function(t, s) {
  if (t instanceof Error) return this.errorHandler(t, s);
  throw t;
}, "rt"), at = /* @__PURE__ */ __name(function(t, s, i, a) {
...
var js = [];
function Ti(e, t) {
  const s = this.buildAllMatchers(), i = /* @__PURE__ */ __name(((a, r) => {
...
}, X = /* @__PURE__ */ new WeakMap(), ee = /* @__PURE__ */ new WeakMap(), gt = /* @__PURE__ */ new WeakSet(), Os = /* @__PURE__ */ __name(function(e) {
  const t = [];
  let s = e === R;
...
}, se = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap(), pe = /* @__PURE__ */ new WeakMap(), $e = /* @__PURE__ */ new WeakMap(), I = /* @__PURE__ */ new WeakMap(), Y = /* @__PURE__ */ new WeakSet(), oe = /* @__PURE__ */ __name(function(t, s, i, a, r) {
...
var Yt = /* @__PURE__ */ __name((e) => (e[Ls] = true, e), "Yt");
var Bs = /* @__PURE__ */ __name((e) => ({ value: t, children: s }) => {
  if (!s) return;
...
var _e = /* @__PURE__ */ __name((e) => e.values.at(-1), "_e");
var ft = { title: [], script: ["src"], style: ["data-href"], link: ["href"], meta: ["name", "httpEquiv", "charset", "itemProp"] };
var jt = {};
var le = "data-precedence";
var Hs = /* @__PURE__ */ __name((e) => e.rel === "stylesheet" && "precedence" in e, "Hs");
var Fs = /* @__PURE__ */ __name((e, t) => e === "link" ? t : ft[e].length > 0, "Fs");
var Ye = /* @__PURE__ */ __name((e) => Array.isArray(e) ? e : [e], "Ye");
var Jt = /* @__PURE__ */ new WeakMap();
var Qt = /* @__PURE__ */ __name((e, t, s, i) => ({ buffer: a, context: r }) => {
  if (!a) return;
  const n = Jt.get(r) || {};
  Jt.set(r, n);
  const o = n[e] || (n[e] = []);
...
var Je = /* @__PURE__ */ __name((e, t, s) => N(new B(e, s, Ye(t ?? [])).toString()), "Je");
var Qe = /* @__PURE__ */ __name((e, t, s, i) => {
...
var Gi = /* @__PURE__ */ __name(({ children: e, ...t }) => {
  const s = Dt();
  if (s) {
    const i = _e(s);
...
var Vi = /* @__PURE__ */ __name(({ children: e, ...t }) => {
  const s = Dt();
  return ["src", "async"].some((i) => !t[i]) || s && _e(s) === "head" ? Je("script", e, t) : Qe("script", e, t, false);
}, "Vi");
var zi = /* @__PURE__ */ __name(({ children: e, ...t }) => ["href", "precedence"].every((s) => s in t) ? (t["data-href"] = t.href, delete t.href, Qe("style", e, t, true)) : Je("style", e, t), "zi");
var Wi = /* @__PURE__ */ __name(({ children: e, ...t }) => ["onLoad", "onError"].some((s) => s in t) || t.rel === "stylesheet" && (!("precedence" in t) || "disabled" in t) ? Je("link", e, t) : Qe("link", e, t, Hs(t)), "Wi");
var Ki = /* @__PURE__ */ __name(({ children: e, ...t }) => {
  const s = Dt();
  return s && _e(s) === "head" ? Je("meta", e, t) : Qe("meta", e, t, false);
}, "Ki");
var Us = /* @__PURE__ */ __name((e, { children: t, ...s }) => new B(e, s, Ye(t ?? [])), "Us");
var Yi = /* @__PURE__ */ __name((e) => (typeof e.action == "function" && (e.action = pt in e.action ? e.action[pt] : void 0), Us("form", e)), "Yi");
var qs = /* @__PURE__ */ __name((e, t) => (typeof t.formAction == "function" && (t.formAction = pt in t.formAction ? t.formAction[pt] : void 0), Us(e, t)), "qs");
var Ji = /* @__PURE__ */ __name((e) => qs("input", e), "Ji");
var Qi = /* @__PURE__ */ __name((e) => qs("button", e), "Qi");
...
var ht = /* @__PURE__ */ __name((e) => Zi.get(e) || e, "ht");
...
var tr = 256;
var De = /* @__PURE__ */ __name((e, t, s) => {
  e.size >= t && e.clear(), e.add(s);
}, "De");
var sr = /* @__PURE__ */ __name((e) => Xt.has(e) ? true : typeof e != "string" ? false : e.length === 0 ? true : er.test(e) ? false : (De(Xt, tr, e), true), "sr");
...
var He = void 0;
var Dt = /* @__PURE__ */ __name(() => He, "Dt");
var lr = /* @__PURE__ */ __name((e) => /[A-Z]/.test(e) && e.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/) ? e.replace(/([A-Z])/g, "-$1").toLowerCase() : e, "lr");
...
var ur = /* @__PURE__ */ __name(({ children: e }) => new Vs("", { children: e }, Array.isArray(e) ? e : e ? [e] : []), "ur");
function tt(e, t, s) {
  let i;
...
var rs = /* @__PURE__ */ __name((e, t) => Re && e instanceof SVGElement && /[A-Z]/.test(t) && (t in e.style || t.match(/^(?:o|pai|str|u|ve)/)) ? t.replace(/([A-Z])/g, "-$1").toLowerCase() : t, "rs");
var zs = /* @__PURE__ */ __name((e) => e == null || e === false ? null : e, "zs");
var mr = /* @__PURE__ */ __name((e, t) => {
  "value" in t && (e.value = zs(t.value), !e.multiple && e.selectedIndex === -1 && (e.selectedIndex = 0));
}, "mr");
var as = /* @__PURE__ */ __name((e) => e instanceof DOMException && e.name === "InvalidCharacterError", "as");
var gr = /* @__PURE__ */ __name((e, t, s) => {
  var i;
  t || (t = {});
  for (let a in t) {
    const r = t[a];
    if (a !== "children" && (!s || s[a] !== r)) {
      ...
      if (n) {
        ...
        let o;
        typeof r == "function" ? o = r(e) || (() => r(null)) : r && "current" in r && (r.current = e, o = /* @__PURE__ */ __name(() => r.current = null, "o")), Mt.set(e, o);
      } else if (a === "style") {
        const o = e.style;
...
var Ws = /* @__PURE__ */ __name((e, t, s, i, a) => {
  var r, n;
...
var xr = /* @__PURE__ */ __name((e, t) => !!(e && e.length === t.length && e.every((s, i) => s[1] === t[i][1])), "xr");
...
var Ot = /* @__PURE__ */ __name((e, t, s) => {
  ...
  try {
    ...
    if (h) {
      const g = /* @__PURE__ */ __name(() => ct([0, false, e[2]], m), "g"), v = lt.get(m) || [];
      v.push(g), lt.set(m, v);
      const k = h(p, () => {
        const w = lt.get(m);
        if (w) {
...
var cs = [];
var ct = /* @__PURE__ */ __name(async (e, t) => {
  e[5] || (e[5] = []);
  const s = Ne.get(t);
  s && s[0](void 0);
  let i;
...
var wr = /* @__PURE__ */ __name((e, t, s) => ({ tag: Fe, props: { children: e }, key: s, e: t, p: 1 }), "wr");
var Ct = 0;
var Qs = 1;
var $t = 2;
var Tt = 3;
var Pt = /* @__PURE__ */ new WeakMap();
var Zs = /* @__PURE__ */ __name((e, t) => !e || !t || e.length !== t.length || t.some((s, i) => s !== e[i]), "Zs");
var kr = void 0;
var ds = [];
var Er = /* @__PURE__ */ __name((e) => {
  var n;
  const t = /* @__PURE__ */ __name(() => typeof e == "function" ? e() : e, "t"), s = Ue.at(-1);
  if (!s) return [t(), () => {
  }];
...
var Ut = /* @__PURE__ */ __name((e, t) => Sr(() => (s) => {
  let i;
  e && (typeof e == "function" ? i = e(s) || (() => {
    e(null);
  }) : e && "current" in e && (e.current = s, i = /* @__PURE__ */ __name(() => {
    e.current = null;
  }, "i")));
  const a = t(s);
  return () => {
...
var Ze = /* @__PURE__ */ __name((e, t, s, i, a) => {
  ...
  const h = ft[e], m = Fs(e, i), g = /* @__PURE__ */ __name((E) => E.getAttribute("rel") === "stylesheet" && E.getAttribute(le) !== null, "g");
  let v;
  if (m) {
...
var Pr = /* @__PURE__ */ __name((e) => !e || ["src", "async"].some((t) => !e[t]) ? { tag: "script", props: e, type: "script", ref: e.ref } : Ze("script", e, 1, false, true), "Pr");
var Rr = /* @__PURE__ */ __name((e) => !e || !["href", "precedence"].every((t) => t in e) ? { tag: "style", props: e, type: "style", ref: e.ref } : (e["data-href"] = e.href, delete e.href, Ze("style", e, 2, true, true)), "Rr");
var _r = /* @__PURE__ */ __name((e) => !e || ["onLoad", "onError"].some((t) => t in e) || e.rel === "stylesheet" && (!("precedence" in e) || "disabled" in e) ? { tag: "link", props: e, type: "link", ref: e.ref } : Ze("link", e, 1, Hs(e), true), "_r");
var Ir = /* @__PURE__ */ __name((e) => Ze("meta", e, void 0, false, false), "Ir");
...
var ei = /* @__PURE__ */ __name((e, { formAction: t, ...s }) => {
...
var Mr = /* @__PURE__ */ __name((e) => ei("input", e), "Mr");
var Or = /* @__PURE__ */ __name((e) => ei("button", e), "Or");
Object.assign(jt, { title: Tr, script: Pr, style: Rr, link: _r, meta: Ir, form: jr, input: Mr, button: Or });
Bt(null);
var ps = new TextEncoder();
var Nr = /* @__PURE__ */ __name((e, t = console.trace) => {
  let s = false;
...
var Lr = Bt(null);
var Br = /* @__PURE__ */ __name((e, t, s, i) => (a, r) => {
...
var Dr = /* @__PURE__ */ __name((e, t) => function(i, a) {
...
boardroom-ready.`;
var Jr = /* @__PURE__ */ __name((e) => `Generate today's Daily Battle Brief for a ${e.industry} business
...
var Zr = /* @__PURE__ */ __name((e) => `Fetch ${e}. Extract: (1) all visible prices and currency, (2)
...
var ea = /* @__PURE__ */ __name(() => qt({ title: "RealityPulse \u2014 Bloomberg Terminal for SMBs", bodyHTML: `
<!-- Navbar -->
...
`, "Rt");
var ta = /* @__PURE__ */ __name(() => qt({ title: "Set up your tenant \u2014 RealityPulse", bodyHTML: `
...
<\/script>
` }), "ta");
var si = /* @__PURE__ */ __name((e = false) => qt({ title: e ? "Public Threat Index \u2014 RealityPulse" : "Command Center \u2014 RealityPulse", bodyHTML: `
<!-- TOP NAV -->
...
// ../.wrangler/tmp/bundle-PqSEUZ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-PqSEUZ/middleware-loader.entry.ts
...
//# sourceMappingURL=bundledWorker-0.8545474402286868.mjs.map
